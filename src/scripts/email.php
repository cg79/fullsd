...
if ($name == "") {
    ...
    $headers .= 'From:  Digital Marketo <contact@axilweb.com>' . "\r\n";
    $headers .= 'cc: amit@axilweb.com' . "\r\n";
    $headers .= 'bcc: shajed@axilweb.com' . "\r\n";
    mail($to, $subject, $message, $headers, '-f syed@axilweb.com');
