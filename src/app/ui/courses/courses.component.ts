...
export class CoursesComponent implements OnInit {
  ...
  ro = [
    {
      title:"<p><img src='images/slider/javascript_200.png'><label>Javascript</label><em> Sedinta 1</em></p>",
    ...
    {
    title:"<p><img src='images/slider/algorithms_200.png' ><label>Algoritmica</label></p>",
      ...
      {
        title:"<p><img src='images/slider/git.png'><label>Codul sursa</label></p>",
    ...
    {
      title:"<p><img src='images/slider/designpatternsjs.jpg'><label>Design Patterns</label></p>",
    ...
    {
      title:"<p><img src='images/slider/nodejs.jpg'><label>Node.js</label></p>",
    ...
    {
      title:"<p><img src='images/slider/mongodb.jpg'><label>Mongo</label></p>",
    ...
    {
      title:"<p><img src='images/slider/es6.png'><label>Es6</label></p>",
    ...
    {
      title:"<p><img src='images/slider/html.png'><label>Html</label></p>",
    ...
    {
      title:"<p><img src='images/slider/html.png'><label>Css</label></p>",
    ...
    {
      title:"<p><img src='images/slider/jquery.png'><label>JQuery</label></p>",
    ...
    {
      title:"<p><img src='images/slider/angular1.png'><label>Angular1</label></p>",
    ...
    {
      title:"<p><img src='images/slider/typescript.png'><label>typescript</label></p>",
    ...
    {
      title:"<p><img src='images/slider/ang5.png'><label>angular</label></p>",
    ...
    {
      title:"<p><img src='images/slider/testing.png'><label>Testare</label></p>",
    ...
    {
      title:"<p><img src='images/slider/react.png'><label>react</label></p>",
    ...
    {
      title:"<p><img src='images/slider/mobile.png'><label>react</label></p>",
    ...
    {
      title:"<p><img src='images/slider/docker.png'><label>react</label></p>",
  ...
  en = [
    ...
    },
    {
      title:"",
      text: '\n' +
      'Javascript statements. Like any programming language, javascript provides programmer with specific syntax for creating algorithms. For example, to display the payment amount of a shopping cart, using written algorithms using these syntaxes.\n' +
        ...
        },
    {
      title:"",
        ...
        {
          title:"",
          text: 'Angular 6 is the new way to make websites (front-end). This technology is highly sought after and will be used to create the application for each team.\n' +
